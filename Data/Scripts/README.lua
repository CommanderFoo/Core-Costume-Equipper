...
To modify the costume to use your own objects. Deinstance the template and add objects to the groups inside of
the sockets. By default a cube is in all sockets which can be removed.

There is one property on the root of the template called `HidePlayer`. Toggling this option will hide/show the
player when the costume is equipped.

Inside of the template there is a folder called Footsteps Audio. Any audio clips in that folder will be played
